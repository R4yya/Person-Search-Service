...
image1 = face_recognition.load_image_file(f'{project_path}\\img_bytes\\test_durov_1.bin')
image2 = face_recognition.load_image_file(f'{project_path}\\img_bytes\\durov.bin')
...
face_embeddings1 = np.array(face_recognition.face_encodings(image1, face_locations1))
face_embeddings2 = np.array(face_recognition.face_encodings(image2, face_locations2))
